...
?>
	...
	<div class="container py-0">
		<!-- <h1>ES UNA CATEGORÍA SIN HIJOS</h1> -->
		<!-- Post Ciudades -->
		<div class="container py-0">
        <div class="row top-child-category row-cols-2 row-cols-md-3 g-1 g-sm-4 my-0 py-0 my-sm-3">
			<?php 
				$masposts = obtener_ult_posts_ciudad($current_category->term_taxonomy_id); 
				// var_dump($current_category->term_taxonomy_id);
			?>
            
        </div>
		<?php if($masposts) : ?>
        <div class="row text-center">
          <a href="#" class="button_arrow">Ver más artículos <img class="ps-2" src="<?php echo esc_url( get_template_directory_uri() . '/images/ico-flecha-light.svg' ); ?>" alt=""></a>
        </div>
		<?php endif ?>
    </div>
    <!-- Fin Post Ciudades -->
